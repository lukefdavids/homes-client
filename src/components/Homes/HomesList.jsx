  ...
  return (
    <>
      <div id="titles" className="flex flex-col max-w-screen">
        <h1 className="lg:text-8xl text-2xl md:text-6xl  font-serif shadow-2xl font-bold text-slate-800">
          NASHVILLE HOMES
        </h1>
        <h3 className="text-2xl md:text-4xl lg:text-6xl font-serif italic text-slate-800 py-4">
